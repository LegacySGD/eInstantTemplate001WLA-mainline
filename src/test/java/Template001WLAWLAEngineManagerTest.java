...
public class Template001WLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(Template001WLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/Template001WLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/Template001WLAIW/InitOutcome.xml").getDocumentElement();
